...
namespace ArjunFormBuilder.BLL
{
    public class Form1
    {
        ArjunFormBuilder.DAL.Form1 _Form1 = new ArjunFormBuilder.DAL.Form1();
        ...
        public List<ArjunFormBuilder.Entities.Form1> GetForm1List(ref int status)
        {
            List<ArjunFormBuilder.Entities.Form1> lstForm1 = new List<ArjunFormBuilder.Entities.Form1>();
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                {
                    ArjunFormBuilder.Entities.Form1 objlstForm1 = new ArjunFormBuilder.Entities.Form1();
        ...
        public ArjunFormBuilder.Entities.Form1 GetForm1ById(Int64 CompetitionRegistrationId, ref int status)
        {
            ArjunFormBuilder.Entities.Form1 objForm1 = new ArjunFormBuilder.Entities.Form1();
        ...
        public List<ArjunFormBuilder.Entities.Form1> GetForm1ListByVariable(Int64 EventId, Int64 RegistrationCategoryId, Int64 PaymentMethodId, Int64 PaymentStatusId, string Search, string Sort, int PageNo, int Items, ref int Total)
        {
            List<ArjunFormBuilder.Entities.Form1> lstForm1 = new List<ArjunFormBuilder.Entities.Form1>();
